...
public class ColliderTracker : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider obj)
    {
        ...
        if (stopTyp == stopType.TIME)
        {
            ...
            {
                timerIsRunning = true;
                _timeText = "Countdown has started at " + timeRemaining;
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        else
        {
            ...
            stopwatch.Stop();
            _timeText = "Time spent inside the object :" + stopwatch.Elapsed.ToString("mm\\:ss\\.ff");
            timeText.text = _timeText;
            ...
            _distaceText = "The longest distance moved past entering the wall :" + t.distance(pos);
