...
public class NaiveDistance : MonoBehaviour
{
    ...
    string _distaceText = "";
    public Text distaceStopText;
    string _distaceStopText = "";
    ...
    void Update()
    {
        ...
        if (inputDevice != null && !isPressed && wasPressed)
        {
            ...
            {
                wasPressed = false;
                _distaceText = "The start pos :" + t.returnPos(tracedDevice);
            ...
            {
                wasPressed = false;
                _distaceStopText = "The stop positon:" + t.returnPos(tracedDevice) + "\nThe distance moved :" + System.Math.Round(t.distance(pos), 2);
            ...
            distaceStopText.text = _distaceStopText;
